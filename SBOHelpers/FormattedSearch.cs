...
namespace SBO.Hub.SBOHelpers
{
    public class FormattedSearch
    {
        ...
        public int CreateQuery(string QueryName, string TheQuery, string categoryName = "Geral")
        {
            ...
            Recordset oRS = (Recordset)SBOApp.Company.GetBusinessObject(BoObjectTypes.BoRecordset);
            UserQueries oQuery = (UserQueries)SBOApp.Company.GetBusinessObject(BoObjectTypes.oUserQueries);
