...
namespace SBO.Hub
{
    public class SBOApp
    {
        ...
        public static string StatusBarMessage { get; set; } = "";
       ...
       // public static TranslatorTool Translator { get; private set; }
        ...
        public static bool AutoTranslateHana { get; set; } = false;
        #endregion
        ...
        {
            if (Company.DbServerType == (BoDataServerTypes)9 && AutoTranslateHana) // 9 = Hana
            {
